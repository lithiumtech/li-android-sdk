...
public class LiQueryConstant {
    ...
    public static final String LI_ARTICLES_CLIENT_BASE_LIQL = "SELECT id, subject, view_href, post_time, kudos.sum(weight), conversation.style, conversation.solved, conversation.last_post_time, user_context, author, parent.id FROM messages";
    ...
    public static final String LI_MESSAGE_CHILDREN_CLIENT_BASE_LIQL = "SELECT id, body, subject, view_href, post_time, kudos.sum(weight), can_accept_solution, is_solution, user_context.kudo, user_context.can_kudo, user_context.can_reply, user_context.read, user_context.can_delete, author.id, author.avatar, author.login, parent.id FROM messages";
    ...
    public static final String LI_ARTICLES_BROWSE_CLIENT_BASE_LIQL = "SELECT id, subject, view_href, post_time, kudos.sum(weight), conversation.style, conversation.solved, conversation.last_post_time, user_context, author, parent.id FROM messages";
    ...
    public static final String LI_MESSAGE_CLIENT_BASE_LIQL = "SELECT id, body, subject, view_href, post_time, kudos.sum(weight), can_accept_solution, is_solution, user_context.kudo, user_context.can_kudo, user_context.can_reply, user_context.can_delete, author.id, author.avatar, author.login, parent.id FROM messages";
