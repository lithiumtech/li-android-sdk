...
public final class LiAuthorizationException extends Exception {

    /**
     * The extra string that used to store an {@link LiAuthorizationException} in an intent by
     * {@link #toIntent()}.
     */
    public static final String EXTRA_EXCEPTION = "lithium.community.android.sdk.auth.LiAuthorizationException";
    ...
    @VisibleForTesting
    protected static final String KEY_ERROR_DESCRIPTION = "errorDescription";

    @VisibleForTesting
    protected static final String KEY_ERROR_URI = "errorUri";
     ...
     */
    public LiAuthorizationException(
            int type,
            int code,
    ...
    public static LiAuthorizationException generalEx(int code, @Nullable String errorDescription) {
        return new LiAuthorizationException(
                TYPE_GENERAL_ERROR, code, null, errorDescription, null, null);
    }

    private static LiAuthorizationException authEx(int code, @Nullable String error) {
        return new LiAuthorizationException(
                TYPE_OAUTH_AUTHORIZATION_ERROR, code, error, null, null, null);
    }

    private static LiAuthorizationException tokenEx(int code, @Nullable String error) {
        return new LiAuthorizationException(
                TYPE_OAUTH_TOKEN_ERROR, code, error, null, null, null);
    }

    private static LiAuthorizationException registrationEx(int code, @Nullable String error) {
        return new LiAuthorizationException(
     ...
     */
    public static LiAuthorizationException fromTemplate(
            @NonNull LiAuthorizationException ex,
            @Nullable Throwable rootCause) {
        return new LiAuthorizationException(
                ex.type,
                ex.code,
     ...
     */
    public static LiAuthorizationException fromOAuthTemplate(
            @NonNull LiAuthorizationException ex,
    ...
    /**
     * Reconstructs an {@link LiAuthorizationException} from the JSON produced by
     * {@link #toJsonString()}.
     *
     ...
     * @throws JSONException if the JSON is malformed or missing required properties
     */
    public static LiAuthorizationException fromJson(@NonNull JSONObject json) throws JSONException {
        LiCoreSDKUtils.checkNotNull(json, "json cannot be null");
        return new LiAuthorizationException(
                json.getInt(KEY_TYPE),
                json.getInt(KEY_CODE),
                LiCoreSDKUtils.getStringIfDefined(json, KEY_ERROR),
                LiCoreSDKUtils.getStringIfDefined(json, KEY_ERROR_DESCRIPTION),
                LiCoreSDKUtils.getUriIfDefined(json, KEY_ERROR_URI),
                null);
    }
    ...
    private static Map<String, LiAuthorizationException> exceptionMapByString(
            LiAuthorizationException... exceptions) {
        ArrayMap<String, LiAuthorizationException> map =
                new ArrayMap<>(exceptions != null ? exceptions.length : 0);

        if (exceptions != null) {
            for (LiAuthorizationException ex : exceptions) {
                if (ex.error != null) {
                    map.put(ex.error, ex);
                }
            }
    ...
    public JSONObject toJson() {
        ...
        LiCoreSDKUtils.put(json, KEY_TYPE, type);
        LiCoreSDKUtils.put(json, KEY_CODE, code);
        LiCoreSDKUtils.putIfNotNull(json, KEY_ERROR, error);
        LiCoreSDKUtils.putIfNotNull(json, KEY_ERROR_DESCRIPTION, errorDescription);
        LiCoreSDKUtils.putIfNotNull(json, KEY_ERROR_URI, errorUri);
        return json;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof LiAuthorizationException)) {
            return false;
        }

        LiAuthorizationException other = (LiAuthorizationException) obj;
    ...
    public String toString() {
        return "LiAuthorizationException: " + toJsonString();
    }
    ...
    public static final class AuthorizationRequestErrors {
         ...
         */
        public static final LiAuthorizationException UNAUTHORIZED_CLIENT =
                authEx(1001, "unauthorized_client");

        /**
         * An {@code access_denied} OAuth2 error response.
         */
        public static final LiAuthorizationException ACCESS_DENIED =
                authEx(1002, "access_denied");

        /**
         * An {@code unsupported_response_type} OAuth2 error response.
         */
        public static final LiAuthorizationException UNSUPPORTED_RESPONSE_TYPE =
                authEx(1003, "unsupported_response_type");

        /**
         * An {@code invalid_scope} OAuth2 error response.
         */
        public static final LiAuthorizationException INVALID_SCOPE =
         ...
         */
        public static final LiAuthorizationException TEMPORARILY_UNAVAILABLE =
         ...
         */
        public static final LiAuthorizationException CLIENT_ERROR =
                authEx(1007, null);
        ...
        private static final Map<String, LiAuthorizationException> STRING_TO_EXCEPTION =
         ...
         */
        @NonNull
        public static LiAuthorizationException byString(String error) {
            LiAuthorizationException ex = STRING_TO_EXCEPTION.get(error);
            if (ex != null) {
                return ex;
            }
            return OTHER;
    ...
    public static final class TokenRequestErrors {
         ...
         */
        public static final LiAuthorizationException INVALID_CLIENT =
                tokenEx(2001, "invalid_client");

        /**
         * An {@code invalid_grant} OAuth2 error response.
         */
        public static final LiAuthorizationException INVALID_GRANT =
         ...
         */
        public static final LiAuthorizationException UNSUPPORTED_GRANT_TYPE =
    ...
    public static final class RegistrationRequestErrors {
         ...
         * An {@code invalid_client} OAuth2 error response.
         */
        public static final LiAuthorizationException INVALID_REDIRECT_URI =
                registrationEx(4001, "invalid_redirect_uri");

        /**
         * An {@code invalid_grant} OAuth2 error response.
         */
        public static final LiAuthorizationException INVALID_CLIENT_METADATA =
