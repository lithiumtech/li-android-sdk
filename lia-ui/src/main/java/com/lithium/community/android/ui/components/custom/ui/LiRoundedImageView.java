...
public class LiRoundedImageView extends ImageView {
    ...
    public LiRoundedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LiRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
